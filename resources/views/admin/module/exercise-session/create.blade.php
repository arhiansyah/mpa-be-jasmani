            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body p-3 p-md-4">
                        <form action="{{ route('exercise-session.store') }}" method="post" enctype='multipart/form-data'>
                            @csrf
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control groupTrainingAll" name="groupTraining[]" multiple="multiple" style="width: 100%; height: 100%;">
                                                @foreach ($groupTraining as $grotrain)
                                                <option value="{{ $grotrain->id }}">{{ $grotrain->name }}</option>
                                                @endforeach
                                            </select>
                                        </td>
                                    </tr>
