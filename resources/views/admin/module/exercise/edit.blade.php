                            ...
                            <table class="table table-responsive table-borderless">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $exercise->name) }}">
                                            @error('name')
                                    ...
                                    <tr>
                                        <td>Description</td>
                                        <td>:</td>
                                        <td><textarea name="description" id="description">{{ $exercise->description }}</textarea>
                                            @error('description')
                                    ...
                                    <tr>
                                        <td>Measurement</td>
                                        <td>:</td>
                                        <td><textarea name="measurement" id="measurement">{{ $exercise->measurement }}</textarea>
                                            @error('measurement')
                                            <div id="iconFeedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <img src="{{ route('showimage', $exercise->video) }}" style="height: 160px" class="mb-3" alt="{{ $exercise->slug }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <img src="{{ route('showimage', $exercise->icon) }}" style="height: 160px" class="mb-3" alt="{{ $exercise->slug }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <img src="{{ route('showimage', $exercise->cover) }}" style="height: 280px" class="mb-3" alt="{{ $exercise->slug }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>
                                            <img src="{{ route('showimage', $exercise->animation) }}" style="height: 280px" class="mb-3" alt="{{ $exercise->slug }}">
